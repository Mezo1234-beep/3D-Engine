...
class GuiHelper():
    ...
    def addSkySeaDialog(self, command=None):
        ...
        labels = ['Terrain Tile:', 'Terrain Scale:', 'Sky Tile:', 'Cloud Speed:', 'Wave Tile:', 'Wave Height:',
                  'Wave XY Move:', 'Water Tile:', 'Water Speed:', 'Water Level:\n(-1 to disable)']
    ...
    def addScrolledToolbar(self, parent, width, canvas_size, x_offset=0, y_offset=0, hover_command=False,
                           color=(1, 0, 0, 0)):
        wp = base.win.getProperties()
